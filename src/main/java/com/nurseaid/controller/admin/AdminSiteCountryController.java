...
import com.nurseaid.security.TblCountryValidator;
import com.nurseaid.security.TblMessageValidator;
import com.nurseaid.service.CMSService;
import com.nurseaid.service.CountryService;
...
public class AdminSiteCountryController extends AdminBaseController{
	
	HashMap<Integer, String[]> breadcrumb;
	CountryService service = new CountryService();
	TblCountryValidator v = new TblCountryValidator();
	
	
	public AdminSiteCountryController(){
	...
	public void buildBreadCrumb()
	{
		...
		breadcrumb.put(2, new String[]{"#", "active", " Country"});
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/admin/site/country", method = RequestMethod.GET)
	public String getAdminList(Locale locale, Model model, HttpSession sess) {
		buildBreadCrumb();
		model.addAttribute("breadcrumb", breadcrumb);
		model.addAttribute("list", service.getAll());
		return "admin/site/country";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/admin/site/country/add", method = {RequestMethod.GET, RequestMethod.POST})
	public String addUser(@ModelAttribute("ObjForm") @Validated TblCountry obj_form,
			BindingResult result, final RedirectAttributes ra, Model model, HttpSession sess, HttpServletRequest req) {
		
		
		buildBreadCrumb();
		breadcrumb.replace(2, new String[]{"/admin/site/country", "", " Country"});
		...
		if(RequestUtility.isPost(req))
		{
			...
			{				
				...
				{	
					...
					return "redirect:/admin/site/country";
				}
				else
				{
	 ...
	 * @return
	 */
	@RequestMapping(value = "/admin/site/country/edit/{id}", method = {RequestMethod.GET, RequestMethod.POST})
	public String editUser(@ModelAttribute("ObjForm") @Validated TblCountry obj_form,
		...
		{
			TblCountry obj = new TblCountry();
			obj = (TblCountry)service.getById(id);
			model.addAttribute("ObjForm", obj);
			return "admin/site/country/add";
		}
		else 
	 ...
	 * @return
	 */
	@RequestMapping(value = "/admin/site/country/delete/{id}", method = {RequestMethod.GET})
