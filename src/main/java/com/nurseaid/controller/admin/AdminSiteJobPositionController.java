...
import com.nurseaid.security.TblJobPositionValidator;
...
public class AdminSiteJobPositionController extends AdminBaseController {
	
	HashMap<Integer, String[]> breadcrumb;
	JobPositionService service = new JobPositionService();
	TblJobPositionValidator v = new TblJobPositionValidator();
	
	
	public AdminSiteJobPositionController(){
	...
	public void buildBreadCrumb()
	{
		...
		breadcrumb.put(2, new String[]{"#", "active", " Job Positions"});
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/admin/site/job_position", method = RequestMethod.GET)
	public String getAdminList(Locale locale, Model model, HttpSession sess) {
		buildBreadCrumb();
		model.addAttribute("breadcrumb", breadcrumb);
		model.addAttribute("list", service.getAll());
		return "admin/site/job_position";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/admin/site/job_position/add", method = {RequestMethod.GET, RequestMethod.POST})
	public String addUser(@ModelAttribute("ObjForm") @Validated TblJobPosition obj_form,
			BindingResult result, final RedirectAttributes ra, Model model, HttpSession sess, HttpServletRequest req) {
		
		
		buildBreadCrumb();
		breadcrumb.replace(2, new String[]{"/admin/site/job_position", "", " Job Positions"});
		...
		if(RequestUtility.isGet(req))
		{
			...
			TblJobPosition obj = new TblJobPosition();
			model.addAttribute("ObjForm", obj);
			return "admin/site/job_position/add";
		}
		else 
		if(RequestUtility.isPost(req))
		{
			...
			{				
				...
				{	
					...
					return "redirect:/admin/site/job_position";
				}
				else
				{
	 ...
	 * @return
	 */
	@RequestMapping(value = "/admin/site/job_position/edit/{id}", method = {RequestMethod.GET, RequestMethod.POST})
	public String editUser(@ModelAttribute("ObjForm") @Validated TblJobPosition obj_form,
		...
		{
			TblJobPosition obj = new TblJobPosition();
			obj = (TblJobPosition)service.getById(id);
			model.addAttribute("ObjForm", obj);
			return "admin/site/job_position/add";
		}
		else 
	 ...
	 * @return
	 */
	@RequestMapping(value = "/admin/site/job_position/delete/{id}", method = {RequestMethod.GET})
	public String deleteJobType(final RedirectAttributes ra, Model model, HttpSession sess, HttpServletRequest req, @PathVariable String id) {
