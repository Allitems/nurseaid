...
<c:choose>
	<c:when test="${empty is_front_end}">
		...
		<c:set var="field_class" value="col-md-10 col-sm-10" scope="request"/>
	</c:when>
	<c:otherwise>
...
<spring:bind path="${field_name}">
  <div class="form-group col-md-12">					  
        ...
        <div class="${field_class}">
        	<form:textarea rows="5" path="${field_name}" class="form-control" id="${field_name}" placeholder="${field_placeholder}" />
