						      ...
						      <c:when test="${not empty list}">
						      		<c:forEach var="item" items="${list}">
										<tr>
				                             ...
				                             <td>
				                             	<a href="<c:url value='/admin/employer/edit/${item.getId()}'/>" class="btn btn-info">Edit</a>
				                             	<a href="<c:url value='/admin/employer/delete/${item.getId()}'/>" class="btn btn-danger">Delete</a>
				                             </td>				
				                         </tr>
									</c:forEach>
						      </c:when>
